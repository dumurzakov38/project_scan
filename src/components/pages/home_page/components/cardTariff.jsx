...
export function CardTariff(props) {
  const tariffsContent = props.props.map((tariff, index) => {
    const {
      ...
      included_in_the_tariff_logo,
      active_tariff,
    } = tariff;
    const { price, discounted_price, installment_plan, currency } =
      tariff_price;
    const {
      tariff_name,
      for_whom_tariff,
    ...
    return (
      <Tariff_container
        key={index}
        className="section__tariff--slider__container__cart "
      >
          ...
          <div className="section__tariff--slider__container__cart__content--main">
            <div className="section__tariff--slider__container__cart__content--main--tariff_price">
              <div className="section__tariff--slider__container__cart__content--main--tariff_price__container">
                <div className="section__tariff--slider__container__cart__content--main--tariff_price__container--span">
                  {active_tariff ? <span>Текущий тариф</span> : <></>}
                </div>
                <div className="section__tariff--slider__container__cart__content--main--tariff_price__container__price">
                  <div className="section__tariff--slider__container__cart__content--main--tariff_price__container--price">
                    <p className="section__tariff--slider__container__cart__content--main--tariff_price__container--price--value">
                      {price}
                    </p>
                    <p className="section__tariff--slider__container__cart__content--main--tariff_price__container--currency">
                      {currency}
                    </p>
                  </div>
                  {discounted_price ? (
                    <div className="section__tariff--slider__container__cart__content--main--tariff_price__container--discounted_price">
                      <p className="section__tariff--slider__container__cart__content--main--tariff_price__container--discounted_price--value">
                        {discounted_price}
                      </p>
                      <p className="section__tariff--slider__container__cart__content--main--tariff_price__container--discounted_price--currency">
                        {currency}
                      </p>
                    </div>
                  ) : (
              ...
              {installment_plan ? (
                <p className="section__tariff--slider__container__cart__content--main--installment_plan">
                  {installment_plan}
                </p>
              ) : (
            ...
            <div>
              <div className="section__tariff--slider__container__cart__content--main--included_in_the_tariff">
                <h4 className="section__tariff--slider__container__cart__content--main--included_in_the_tariff--h4">
                  В тариф входит:
                </h4>
                <ul className="section__tariff--slider__container__cart__content--main--included_in_the_tariff--ul">
                  {included_in_the_tariff.map((item, i) => (
                    <li
                      className="section__tariff--slider__container__cart__content--main--included_in_the_tariff--ul__li"
                      key={i}
                    >
                      ...
                      <p className="section__tariff--slider__container__cart__content--main--included_in_the_tariff--ul__li--p">
                        {item}
                      </p>
                    </li>
                  ))}
