...
export function Slider_results() {   
    ...
    return (
        <div className="result__container__content--summary__container--containerSlider">
            <div className="result__container__content--summary__container--containerSlider__container parent" ref={containerRef}>
                <div className="result__container__content--summary__container--containerSlider__container--slider">
                    <div className="result__container__content--summary__container--containerSlider__container--slider__containerSlider">
                        <div className="result__container__content--summary__container--containerSlider__container--slider__containerSlider__containerText">
                            <p className="result__container__content--summary__container--containerSlider__container--slider__containerSlider__containerText--pPeriod">Период</p>
                            <p className="result__container__content--summary__container--containerSlider__container--slider__containerSlider__containerText--pTotal">Всего</p>
                            <p className="result__container__content--summary__container--containerSlider__container--slider__containerSlider__containerText--pRisks">Риски</p>
                        </div>
                        {!swiperLoading ? (
                            <Swiper
                            ...
                            >
                                {newsData.map((item,  index) => (
                                    <SwiperSlide key={index} id={index} className="child result__container__content--summary__container--containerSlider__container--slider__containerSlider__containerSlides__slide">
                                        <div className='result__container__content--summary__container--containerSlider__container--slider__containerSlider__containerSlides__slide--year'>
                                            <h1 className="result__container__content--summary__container--containerSlider__container--slider__containerSlider__containerSlides__slide--h1Date">{item.date}</h1>
                                        </div>
                                        <div className='result__container__content--summary__container--containerSlider__container--slider__containerSlider__containerSlides__slide--count'>
                                            <h3 className="result__container__content--summary__container--containerSlider__container--slider__containerSlider__containerSlides__slide--h1Count">{item.total}</h3>
                                            <h3 className="result__container__content--summary__container--containerSlider__container--slider__containerSlider__containerSlides__slide--h1Risks">{item.risk}</h3>
                                        </div>
                                    </SwiperSlide>
                                ))}
                            </Swiper>
                            ...
                            <div className="result__container__content--summary__container--containerSlider__container--slider__containerSlider__containerLoader">
                                <div>
                                    <img className={(swiperLoading ? " loaderAnimation" : "" )} src={loader_scan} title="Загрузка" alt="Лоадер" />
                ...
                {!swiperLoading && resizeCompleted ? (
                    ...
                    <div className="result__container__content--summary__container--containerSlider__container--btn">
                        <button className={`swiper-button-prev swiper-rtl swiper-button-disabled`} onClick={slidePrev} disabled={true}>
                            <img src={strelka} alt="Назад"/>
                        </button>
                        <button className={`swiper-button-next swiper-rtl swiper-button-disabled`} onClick={slideNext} disabled={true}>
                            <img src={strelka} alt="Вперед"/>
                        </button>
                    </div>
                )}
