    ...
    <div className="result__container__content--documentation--containerMain">
      {news.map((item, index) => {
        ...
        if (item.ok.content.markup.length > 1499) {
          contentText =
            item.ok.content.markup.slice(
              0,
              item.ok.content.markup.indexOf(" ", 1500)
            ) + "... прочтите полностью в источнике!";
        }
        ...
        return (
          <div
            key={index}
            className="result__container__content--documentation--containerMain__article"
          >
            <div className="result__container__content--documentation--containerMain__article--content">
              <div>
                <div className="result__container__content--documentation--containerMain__article--content--containerPublicationDateAndAuthor">
                  <h5 className="result__container__content--documentation--containerMain__article--content--containerPublicationDateAndAuthor--publicationDateH5">
                    {newsItem.newsDate}
                  </h5>
                  <a
                    href={newsItem.linkToNews}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <h5 className="result__container__content--documentation--containerMain__article--content--containerPublicationDateAndAuthor--authorH5">
                      {newsItem.newsSource}
                    </h5>
                  </a>
                </div>
                <div className="result__container__content--documentation--containerMain__article--content--containerTitle">
                  <h1 className="result__container__content--documentation--containerMain__article--content--containerTitle__titleH1">
                ...
                <div className="result__container__content--documentation--containerMain__article--content--containerNewsCategory">
                  {newsItem.categoryNews && (
                    <h6 className="result__container__content--documentation--containerMain__article--content--containerNewsCategory__newsCategoryH6">
                      {newsItem.categoryNews}
                    </h6>
                  )}
                </div>
                <div className="result__container__content--documentation--containerMain__article--content--containerContent">
                  <div className="result__container__content--documentation--containerMain__article--content--containerContent--containerText">
                    <div
                      dangerouslySetInnerHTML={{ __html: newsItem.newsExcerpt }}
                    />
                  </div>
                </div>
              </div>
              <div>
                <div className="result__container__content--documentation--containerMain__article--content--containerLinkToSource">
                  {newsItem.linkToNews ? (
                    ...
                    <button disabled="true">Ссылка не найдена</button>
                  )}
                </div>
