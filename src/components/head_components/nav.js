...
export function Nav(props) {
    ...
    useEffect(() => {        
        ...
        const containerMobileMenu = document.querySelector('.nav__btn--mobileMenu--container');
            ...
            <nav>
                <div className="nav__container content">
                    <div className="nav__btn--logoButton content">
                        <div className="nav__logo">
                            <Link to="/" title="Главная">
                                <img className="logo_scan_img" src={logo_scan} alt="Логотип сервиса 'Скан'" />
                            </Link>
                        </div>
                        <div className="nav__btn--navigation">
                            <ul>
                                ...
                                <li>
                                    <Link to="/nan" title="Тарифы">Тарифы</Link>
                                </li>
                                <li>
                                    <Link to="/nan" title="FAQ">FAQ</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="nav__btn--user">
                        {props.prop ? (
                            <>
                                <div className="nav__btn--user__info--container" ref={elementRef}>
                                        <div className={userLimitInfo ? "nav__btn--user__info--container__limit limit__container__content" : "nav__btn--user__info--container__limit limit__container__content limit__none"}>
                                            <div className="nav__btn--user__info--container__limit__content">
                                                <div className="nav__btn--user__info--container__limit--numberОfUsed">
                                                    <div>
                                                        <p className="nav__btn--user__info--container__limit--text__numberОfUsed">Использовано компаний</p> 
                                                    </div>
                                                ...
                                                <div className="nav__btn--user__info--container__limit--valueTotal">
                                                    <div>
                                                        <p class="nav__btn--user__info--container__limit--text__numberОfUsed">Лимит по компаниям</p>
                                                    </div>
                                                    <div className="nav__btn--user__info--container__limit--number__container">
                                        ...
                                        <div className={userLimitInfo ? "nav__btn--user__info--container__limit limit__container__loader limit__none" : "nav__btn--user__info--container__limit limit__container__loader"}>
                                            <img className={"nav__btn--user__info--container__limit--loader" +  (userLimitInfo ? "" : " loaderAnimation" )} src={loader_scan} title="Загрузка" alt="Лоадер" />
                                        </div>
                                </div>
                                <div className="nav__btn--user__info--container__profile">
                                    <div className="nav__btn--user__info--container__profile--text">
                                        <p></p>
                                        <button title="выйти" onClick={logOutOfAccount}>Выйти</button>
                                    </div>
                            ...
                            <div className="nav__btn--user__container identification">
                                <Link to="/nan">
                                    <button className="nav__btn--user__reg" title="Зарегистрироваться">Зарегистрироваться</button>
                                </Link>
                                <div className="nav__btn--user__trait"></div>
                                <Link to="/login">
                                    <button className="nav__btn--user__auth" title="Войти">Войти</button>
                                </Link>
                            </div>
                        )}
                    </div>
                ...
                <div className="nav__btn--mobileMenu--container">
                    <div className="nav__btn--mobileMenu--container__content content">
                        <div className="nav__btn--mobileMenu--container__content--nav">
                            <div>
                                <img className="logo_scan_img" src={logo_scan_white_opacity} alt="Логотип сервиса 'Скан'" />
                            </div>
                            ...
                            <div className="nav__btn--mobileMenu--container__content--main--button">
                                <div className="nav__btn--mobileMenu--container__content--main--button--containerBtnNavigation">
                                    <div className="nav__btn--mobileMenu--container__content--main--button--containerBtnNavigation__containerBtn mobileNavigationBtnHome">      
                                        <Link to="/" className="nav__btn--mobileMenu--container__content--main--button--containerBtnNavigation__containerBtn__home btnMobileMenu" title="Главная">Главная</Link>
                                    </div>
                                    <div className="nav__btn--mobileMenu--container__content--main--button--containerBtnNavigation__containerBtn mobileNavigationBtnTarifs">
                                        <Link to="/nan" className="nav__btn--mobileMenu--container__content--main--button--containerBtnNavigation__containerBtn__tarifs btnMobileMenu" title="Тарифы">Тарифы</Link>
                                    </div>
                                    <div className="nav__btn--mobileMenu--container__content--main--button--containerBtnNavigation__containerBtn mobileNavigationBtnFaq">
                                        <Link to="/nan" className="nav__btn--mobileMenu--container__content--main--button--containerBtnNavigation__containerBtn__faq btnMobileMenu" title="FAQ">FAQ</Link>
                                    </div>
                                </div>
                                <div className="nav__btn--mobileMenu--container__content--main--button--containerBtnAuthorizationAndRegistration">
                                    <div className="nav__btn--mobileMenu--container__content--main--button--containerBtnAuthorizationAndRegistration__containerRegistration">
                                        <Link to="/nan">
                                            <button className="nav__btn--mobileMenu--container__content--main--button--containerBtnAuthorizationAndRegistration__containerRegistration__btn btnMobileMenu" title="Зарегистрироваться">Зарегистрироваться</button>
                                        </Link>
                                    </div>
                                    <div className="nav__btn--mobileMenu--container__content--main--button--containerBtnAuthorizationAndRegistration__containerAuthorization">
                                        <Link to="/login">
                                            <button  className="nav__btn--mobileMenu--container__content--main--button--containerBtnAuthorizationAndRegistration__containerAuthorization__btn btnMobileMenu" title="Войти">Войти</button>
                                        </Link>
                                    </div>
                                </div>
                            </div>
